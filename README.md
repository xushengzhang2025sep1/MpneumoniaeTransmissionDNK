...
Data and Code for Improving prediction of future Mycoplasma pneumoniae epidemics using data-driven transmission models

This readme file provides an explanation for data, model information and code used in the correspondence
...
National Mycoplasma pneumoniae detection data, along with birth and population data for Denmark spanning January 2011 to March 2025, are provided in the file:
	Data-Denmark-Jan-2011-Mar-2026.csv
